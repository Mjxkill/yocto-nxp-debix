...
E2 : nommage des scènes (clavier virtuel), scènes couvrant les blobs
TAC/DSP + patches synthé (via gui-http), page AUTO MIX web complète,
confirmation avant RAPPEL (anti-fausse-manip live).
