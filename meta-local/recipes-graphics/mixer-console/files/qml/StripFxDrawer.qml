...
Rectangle {
    ...
    // ---- délégués : extraits en fichiers (V14.0 étape 8) — les wrappers
    // Component ci-dessous préservent la chaîne de contextes (ctl + drawer).
    Component { id: plainRow; FxPlainRow {} }
    Component { id: bqRow;    FxBqRow {} }
    Component { id: drcCard;  FxDrcCard {} }
}
