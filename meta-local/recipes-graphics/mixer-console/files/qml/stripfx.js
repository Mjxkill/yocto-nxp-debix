...
function rbjBlob(type, fHz, q, gainDb, fs) {
    ...
    /* V11-AL : le hardware TAC applique H(z)=(N0+2·N1·z⁻¹+N2·z⁻²)/
     * (2³¹−2·D1·z⁻¹−D2·z⁻²) (datasheet éq. 4) → N1 et D1 se stockent
     * DIVISÉS PAR 2. Sans ça, D1≈2cos(w0) des filtres graves sature le
     * Q1.31 → filtre inopérant (validé à l'oreille, nuit du 05→06/07). */
    const N0 = b0 / a0, N1 = b1 / a0 / 2, N2 = b2 / a0,
          D1 = -a1 / a0 / 2, D2 = -a2 / a0;
    const q31 = (x) => {
