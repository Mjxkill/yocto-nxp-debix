...
# GCC 13 warns about potential use-after-free; avoid treating as error
CFLAGS:append = " -Wno-error=use-after-free -Wno-error=stringop-overflow -Wno-error=maybe-uninitialized"
