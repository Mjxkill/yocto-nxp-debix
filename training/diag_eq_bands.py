...
CKPT_PATH = Path('/home/michael/data/mastering_workspace/checkpoints/conv_v4_full_epoch029.pt')
CACHE_PATH = Path('/home/michael/data/mastering_workspace/cache/pair_cache_v2_1s.npz')
