#!/usr/bin/env python3
"""V5.17 — export TFLite INT8 du checkpoint final (mono, 26 outputs).
...
from model import MasteringXXL_conv2d, N_FEATURES_IN_V3, N_PARAMS_OUT_V5_17
...
CACHE      = WORKSPACE / 'cache' / 'pair_cache_v5_16_mel_100ms.npz'
EXPORT_DIR = WORKSPACE / 'tflite_export'
EXPORT_DIR.mkdir(parents=True, exist_ok=True)

N_FRAMES = 10   # 10 trames × 10 ms = fenêtre 100 ms

OUT_F32  = EXPORT_DIR / 'mastering_v5_17_f32.tflite'
OUT_INT8 = EXPORT_DIR / 'mastering_v5_17_int8.tflite'
...
model.eval()
example = (torch.randn(1, N_FEATURES_IN_V3, N_FRAMES),)
