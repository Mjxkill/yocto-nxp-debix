#!/usr/bin/env python3
"""
V9.5.3-v5.11 — Identique v5.9 (200ms window) pour fresh retrain (output-raw vs target-raw).
...
def train(n_pairs=30, epochs=EPOCHS_DEFAULT, lr=LR_DEFAULT,
    ...
    print(f"V9.5.3-v5.9 — delta-matching loss + exciter freq min 5kHz")
...
if __name__ == '__main__':
    ...
    ap.add_argument('--tag', type=str, default='v5_11')
    args = ap.parse_args()
