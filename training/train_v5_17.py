#!/usr/bin/env python3
"""
V9.5.3-v5.17 — Phase 3 — modèle MONO + filtre silences + Huber + input_db 18 dB.
...
from model import (
    MasteringXXL_conv2d, denormalize_params_v5_17,
    N_FEATURES_IN_V3, N_PARAMS_OUT_V5_17, n_parameters,
)
...
def train(n_pairs=30, epochs=EPOCHS_DEFAULT, lr=LR_DEFAULT,
    ...
    print(f"V9.5.3-v5.17 — MONO + filtre silences + Huber RMS + input_db 18 dB")
    ...
    model = MasteringXXL_conv2d(n_input=N_FEATURES_IN_V3,
                                 n_out=N_PARAMS_OUT_V5_17).to(DEVICE)
    print(f"Model: MasteringXXL_conv2d — {n_parameters(model):,} params (in={N_FEATURES_IN_V3}, out={N_PARAMS_OUT_V5_17})")
    ...
    for epoch in range(epochs):
        ...
        for b in range(n_batches):
            ...
            params = denormalize_params_v5_17(params_norm)
...
if __name__ == '__main__':
    ...
    ap.add_argument('--tag', type=str, default='v5_17')
    args = ap.parse_args()
