...
Sorties : /home/michael/data/mastering_workspace/eval_v5_18_ep5/
...
from features_v3 import compute_features_v3, N_FEATURES_V3, FRAME_SIZE, HOP_SIZE
...
CKPT      = WORKSPACE / 'checkpoints' / 'conv_v5_18_full_epoch005.pt'
OUT_DIR   = WORKSPACE / 'eval_v5_18_ep5'
...
def main():
    ...
    model = MasteringXXL_conv2d(n_input=N_FEATURES_V3, n_out=N_PARAMS_OUT_V5_17)
    ...
    for pair in pairs:
        ...
        feats = compute_features_v3(raw.astype(np.float32), sr=SR)  # (n_trames, 85)
        n_tr = feats.shape[0]
