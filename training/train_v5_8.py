#!/usr/bin/env python3
"""
V9.5.3-v5.8 — Window 200 ms + 20 bandes hybrides (log bass + linear aigus).
...
def train(n_pairs=30, epochs=EPOCHS_DEFAULT, lr=LR_DEFAULT,
    ...
    print(f"V9.5.3-v5.8 — 20 bandes hybrides (6 log bass + 14 lin aigus)")
...
if __name__ == '__main__':
    ...
    ap.add_argument('--tag', type=str, default='v5_8')
    args = ap.parse_args()
