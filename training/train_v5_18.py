#!/usr/bin/env python3
"""
V9.5.3-v5.18 — Phase 3 — fix des 3 biais fréquentiels (diag 2026-06-10).
...
def train(n_pairs=30, epochs=EPOCHS_DEFAULT, lr=LR_DEFAULT,
    ...
    print(f"V9.5.3-v5.18 — biais fréquentiels corrigés (features v3 + exciter calibré + loss fiabilité/air/tilt)")
    ...
    print(f"Model: MasteringXXL_conv2d — {n_parameters(model):,} params (in={N_FEATURES_V3}, out={N_PARAMS_OUT_V5_17})")
    ...
    for epoch in range(epochs):
        ...
        ep_L_comp = ep_L_mel = ep_L_mc = ep_L_tilt = 0.0
        ep_rms  = 0.0
        ep_corr = 0.0
        ...
        print(f"  epoch {epoch:>3d} loss={m_loss:.2f} | "
              ...
              f"L_comp={rec['L_compress']:.2f} L_mel={rec['L_mel']:.2f} L_tilt={rec['L_tilt']:.2f} "
...
if __name__ == '__main__':
    ...
    ap.add_argument('--tag', type=str, default='v5_18')
    args = ap.parse_args()
