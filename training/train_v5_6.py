#!/usr/bin/env python3
"""
V9.5.3-v5.6 — 20 bandes log-spaced pour corrélation spectrale fine.
...
def train(n_pairs=30, epochs=EPOCHS_DEFAULT, lr=LR_DEFAULT,
    ...
    print(f"V9.5.3-v5.6 — 20 bandes log-spaced + losses normalisées")
...
if __name__ == '__main__':
    ...
    ap.add_argument('--tag', type=str, default='v5_6')
    args = ap.parse_args()
