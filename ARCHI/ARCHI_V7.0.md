...
| **V8.x suite — Phase B** | **PREEMPT_RT kernel + ASRC HW i.MX 8M Plus + PLC + IRQ affinity** : patch PREEMPT_RT, threadirqs, IRQ USB DWC3 + SAI sur cores 2,3, PLC répétition last period au lieu memset zéros, ASRC matériel SoC (4 modules) pour synchro USB↔DSP hardware | **À FAIRE — cible 0 glitch matériel pro** |
