...
| **E6.d ✓ MVP** | Mixer console DAW SW (`mixer-pro` daemon C) — 26 in × 18 out, 4 bus FX stéréo + sends, socket JSON `/run/mixer-pro.sock` | **GO MVP 2026-05-11** — matrice précise (voies non routées = -inf dB), 48 kHz steady, **latence ALSA interne 8 ms** (mesurée `snd_pcm_delay`). Bus FX en passthrough (TODO E6.e LV2 plugins), E2E acoustique non mesurée (estimée ~14 ms) |
