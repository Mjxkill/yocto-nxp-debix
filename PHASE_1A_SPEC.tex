...
\paragraph{\texttt{sof-imx8mp-tac5212-pipe-masterchain.m4} V2.2}
Pipeline d'entrée de la chaîne master, calqué sur le pattern canonique \texttt{sof/tools/topology/topology1/sof/pipe-volume-playback.m4} (qui compile upstream). Valeurs : 2 canaux, s32le, 96 frames/period (2 ms @ 48 kHz). \textbf{[V2.2]} \texttt{W\_PGA} avec 7 args conformes + prélude \texttt{W\_VENDORTUPLES}/\texttt{W\_DATA}, sans \texttt{define(PGA\_NAME)}, TLV en commentaire libre, kcontrol ref en \texttt{"PIPELINE\_ID Master Volume"}.

\begin{lstlisting}[language={}, basicstyle=\ttfamily\scriptsize]
# Master chain input V2.2 : host PCM -> mbdrc -> pga -> drc -> buf
# Pattern canonique : pipe-volume-playback.m4
