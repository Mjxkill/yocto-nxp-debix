...
\paragraph{\texttt{sof-imx8mp-tac5212-pipe-masterchain.m4} V2.3}
Pipeline d'entrée de la chaîne master, calqué sur les patterns canoniques \texttt{sof/pipe-volume-playback.m4} (W\_PGA + tokens) et \texttt{sof/pipe-multiband-drc-playback.m4} (multiband\_drc coef + MULTIBAND\_DRC\_priv). Valeurs : 2 canaux, s32le, 96 frames/period (2 ms @ 48 kHz). \textbf{[V2.3]} Corrections L1/L2/L3 des noms d'includes et macros + convention \texttt{MY\_} pour les \texttt{CTRL} locaux.
